...
public class Bar {
    static List<Beer> beers = Arrays.asList(
            ...
            new Beer("Dzban Krzysztofa", 0.1, Type.IPA, Arrays.asList("Chinook", "Columbus", "Amarillo")),
            ...
            new Beer("Manka extra strong", 0.1d, Type.IPA, Collections.emptyList()));

    static Beer defaultBeer = new Beer("Perełka Bezalkoholowa", 4.99, Type.PILSNER, Collections.emptyList());
}
